...
Use only these proposal stages: problem, design-goal, design-objective, meta-requirement, design-requirement, design-principle, design-feature, artifact, evaluation, outcome. A domain adjective belongs in a node title or description, never in a new stage. Do not emit empty stages.`;
