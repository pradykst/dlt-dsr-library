...
function fixture(): GeneratedDiagram {
  ...
  return {
    ...
    edges: [
      ...
      { source: "n2", target: "n4", label: "addresses" },
      { source: "n2", target: "n5", label: "addresses" },
      { source: "n4", target: "n6", label: "implements" },
      { source: "n4", target: "n7", label: "implements" },
      { source: "n5", target: "n8", label: "implements" },
      { source: "n6", target: "n9", label: "enables" },
      { source: "n7", target: "n9", label: "enables" },
      { source: "n8", target: "n10", label: "requires" },
      { source: "n9", target: "n11", label: "validates" },
      { source: "n10", target: "n11", label: "validates" },
      { source: "n11", target: "n12", label: "enables" },
    ],
  };
}
