...
function minimalSynthesisPlan(title: string): SynthesisPlan {
  return {
    ...
    requirements: [
      { key: "requirement-one", label: "Ignored requirement label", description: "Ignored requirement description.", supportConceptIds: ["fixture/r1"], reuseStoredConceptId: "fixture/r1" },
      { key: "requirement-two", label: "Preserve accountable continuity", description: "Maintain continuity while bounding disclosure.", supportConceptIds: ["fixture/r2"], reuseStoredConceptId: null },
    ],
    principles: [
      { key: "principle-one", label: "Ignored principle label", description: "Ignored principle description.", supportConceptIds: ["fixture/p1"], reuseStoredConceptId: "fixture/p1" },
      { key: "principle-two", label: "Minimize disclosed context", description: "Reveal only the context required for the decision.", supportConceptIds: ["fixture/p2"], reuseStoredConceptId: null },
    ],
    features: [
      { key: "feature-one", label: "Ignored feature label", description: "Ignored feature description.", supportConceptIds: ["fixture/f1"], reuseStoredConceptId: "fixture/f1" },
      { key: "feature-two", label: "Selective continuity proof", description: "Provide a bounded proof without exposing unrelated history.", supportConceptIds: ["fixture/f2"], reuseStoredConceptId: null },
    ],
    artifact: [],
    evaluation: [{ key: "evaluation-one", label: "Evaluate continuity and privacy", description: "Measure continuity preservation and unnecessary disclosure.", supportConceptIds: ["fixture/e1"], reuseStoredConceptId: null }],
    outcome: [],
    relationships: [
