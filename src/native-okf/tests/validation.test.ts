...
const EXPECTED_TYPE_COUNTS = {
  ...
  "design-goal": 3,
  "design-objective": 81,
  "design-principle": 127,
  "design-requirement": 83,
  "meta-requirement": 64,
  paper: 34,
  reference: 2,
} as const;
