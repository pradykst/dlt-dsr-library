...
const EXPECTED_TYPE_COUNTS = {
  ...
  "design-goal": 3,
  "design-objective": 78,
  "design-principle": 122,
  "design-requirement": 68,
  "meta-requirement": 29,
  paper: 34,
  reference: 2,
} as const;
