...
export const PHASE5_VALID_MOCK_DIAGRAM: GeneratedDiagram = {
  ...
  edges: [
    { source: "problem", target: "traceability", label: "requires" },
    { source: "traceability", target: "quality-evidence", label: "requires" },
    { source: "traceability", target: "identity-control", label: "requires" },
    { source: "quality-evidence", target: "artifact", label: "enables" },
    { source: "identity-control", target: "governance", label: "requires" },
    { source: "governance", target: "artifact", label: "enables" },
