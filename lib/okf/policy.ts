...
export const policyThemes: PolicyTheme[] = [
  ...
  { id: "identity_credentials", label: "decentralized identity / credentials / issuer-verifier-holder", queryTerms: ["identity", "decentralized identity", "credentials", "credential", "did", "vc", "vp", "wallet", "issuer", "verifier", "holder", "revocation", "kyc"], matchTerms: ["identity", "credential", "credentials", "issuer", "verifier", "holder", "wallet", "did", "vc", "vp", "revocation", "status", "proof request", "non-revocation", "public data"], primaryPaperIds: ["SSI_KYC_FRAMEWORK_2022"], secondaryPaperIds: ["HIE_CONSENT_SELF_MANAGEMENT_BLOCKCHAIN_2023", "SHORT_END_STICK_2025", "BLOCKCHAIN_IOT_SDPS_2019"] },
  ...
  { id: "auditability_status", label: "auditability / status history / immutable log / permissioning", queryTerms: ["audit", "auditability", "status", "history", "immutable log", "transaction log", "permission", "permissioning", "traceability", "continuity"], matchTerms: ["audit", "auditable", "status", "history", "transaction log", "immutable", "permission", "trace", "revocation", "monitoring"], primaryPaperIds: ["HIE_CONSENT_SELF_MANAGEMENT_BLOCKCHAIN_2023"], secondaryPaperIds: ["SSI_KYC_FRAMEWORK_2022", "BLOCKCHAIN_IOT_SDPS_2019"] },
...
function forcedPaperIdsForCriteria(criteria: QueryCriteria, query: string) {
  ...
  const hasProductReuse = /product|variant|listing|seller|buyer|marketplace/.test(q) && /commercial|raw|privacy|credential|identity|review|continuity/.test(q);
