...
title: "DP9 - Mutually agreed usage cost"
description: "Provide the system with a module to set up the transaction in order to enable host and user to mutually agree on the usage cost."
...
# Design principle DP9: Mutually agreed usage cost
