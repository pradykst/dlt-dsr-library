...
title: "DP3 - Smart-contract stablecoin royalty enforcement"
description: "The system should algorithmically enforce royalty payout via stablecoin through a smart contract, enabling efficient and transparent payouts."
...
# Design principle DP3: Smart-contract stablecoin royalty enforcement

The system should algorithmically enforce royalty payout via stablecoin through a smart contract, enabling efficient and transparent payouts.
...
* [Design feature DF4: Collectively designed smart contract](./drm-music-industry-df4.md)
