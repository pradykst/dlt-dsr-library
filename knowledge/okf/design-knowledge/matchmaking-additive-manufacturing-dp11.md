...
title: "DP11 - Automated contract execution with hybrid payments"
description: "Design BEMs that allow for automated contract execution with cryptographic token incentives and payment options using fiat currencies."
...
# Design principle DP11: Automated contract execution with hybrid payments

Design BEMs that allow for automated contract execution with cryptographic token incentives and payment options using fiat currencies.
