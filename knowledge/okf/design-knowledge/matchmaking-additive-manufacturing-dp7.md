...
title: "DP7 - Ambidextrous interfaces with data screening"
description: "Design BEMs with ambidextrous user interfaces (manual HMI and automated M2M) and functionality to screen marketplace data."
...
# Design principle DP7: Ambidextrous interfaces with data screening

Design BEMs with ambidextrous user interfaces (manual HMI and automated M2M) and functionality to screen marketplace data.
