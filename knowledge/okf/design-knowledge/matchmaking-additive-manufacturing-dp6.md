...
title: "DP6 - Consumer service-request specification"
description: "Design BEMs that enable consumers to specify their service requests via customizable functionalities and filter options."
...
# Design principle DP6: Consumer service-request specification

Design BEMs that enable consumers to specify their service requests via customizable functionalities and filter options.
...
* [Meta-requirement MR6: Demand Side Information](./matchmaking-additive-manufacturing-mr6.md)
