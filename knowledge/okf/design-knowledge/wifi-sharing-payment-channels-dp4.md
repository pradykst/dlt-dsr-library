...
title: "DP4 - Restrict user access to the host's infrastructure"
description: "Provide the system with a module to restrict user access to the host's private network infrastructure even if the user's identity is known, in order to prevent fraudulent actions."
...
* [Design requirement S#IA: Infrastructure attacks](./wifi-sharing-payment-channels-dr-s-ia.md)
* [Design requirement S#B: Blacklisting](./wifi-sharing-payment-channels-dr-s-b.md)
* [Design requirement S#UPT: User profiling and traceability](./wifi-sharing-payment-channels-dr-s-upt.md)
* [Design requirement AU#LT: Legal risks and tarnished reputation](./wifi-sharing-payment-channels-dr-au-lt.md)
