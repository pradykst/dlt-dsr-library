...
title: "DP3 - Route users to their private network"
description: "Provide the system with a module that provides only bandwidth to the user while users are routed to their private network even if their identity is known, in order to prevent users from conducting..."
...
# Design principle DP3: Route users to their private network
