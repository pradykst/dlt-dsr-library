...
title: "MR-1 - Reduce time-intensity"
description: "Although the clearing and settlement processes have been improved and standardized, settlement and clearing time still vary across some markets and, in most markets, take two business days. The prototype shall minimize process times."
...
# Meta-requirement MR-1: Reduce time-intensity
...
This meta-requirement is proposed by [Designing the future of bond markets: Reducing transaction costs through tokenization](../papers/bond-markets-tokenization-tac.md) (David Cisar, Benjamin Schellinger, Jens-Christian Stoetzer, Vincent Gramlich, Tobias Guggenberger, Nils Urbach, Florian Lennart Weiss, 2025).
...
[3] Source evidence: Table 2 ("List of identified meta-requirements"), TAC dimension: frequency, article p. 8.
