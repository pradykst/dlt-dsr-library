...
title: "DP7 - Minimize transaction costs"
description: "Provide the system with a module to keep transaction costs to a minimum in order to prevent large numbers of micro-payments."
...
# Design principle DP7: Minimize transaction costs
