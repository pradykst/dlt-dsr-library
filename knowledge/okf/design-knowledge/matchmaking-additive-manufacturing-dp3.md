...
title: "DP3 - Minimal on-chain sensitive data"
description: "Design BEMs to prevent unauthorized access to sensitive business data and store only a necessary minimum as a persistent blockchain trust anchor."
...
# Design principle DP3: Minimal on-chain sensitive data

Design BEMs to prevent unauthorized access to sensitive business data and store only a necessary minimum as a persistent blockchain trust anchor.
...
* [Meta-requirement MR3: Data Security & Integrity](./matchmaking-additive-manufacturing-mr3.md)
