...
[3] Source evidence: MR1-MR4 individually stated in Section 3.3.1 (article pp. 5-7); DP1-DP3 individually stated in Section 3.4 (article p. 7); Table 2 (article p. 6) explicitly maps requirement rows to "MR3, DP1 & DP2" (row #10), confirming DP2 also addresses MR3 alongside MR2, in addition to the DP1->MR1/MR3 and DP3->MR4 mappings already present.
