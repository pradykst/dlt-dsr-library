...
* [Design principle DP1: Public-ledger metadata storage](../design-knowledge/drm-music-industry-dp1.md) - The system should store music rights metadata on a distributed ledger using a public blockchain to make licensing structures transparently visible to everyone, so that rights owners can claim royal...
* [Design principle DP2: Consensus-validated metadata on a permissioned chain](../design-knowledge/drm-music-industry-dp2.md) - The system should validate music metadata with a consensus mechanism on a permissioned blockchain and assign a unique identifier to rights owners, so that labels and publishers can ensure consisten...
